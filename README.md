...
A short screen recording showing the workflow processing a receipt photo end-to-end (Telegram → Gemini → Sheets → Drive) is included in this repo: [`demo/workflow-demo.mp4`](demo/telegram-photo-processing-demo.mp4)
